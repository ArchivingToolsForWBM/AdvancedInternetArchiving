...
(function() {
	...
	function Code() {
		if (window.location.href == "https://archive.org/services/wayback-gsheets/check?method=archive") {
			document.querySelectorAll('input[type=checkbox]')[2].checked = true //Check the 3rd option, "Save results in a new Sheet."
		}
	}
})();